...
export default function TituloOrderCell({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', height: 'auto'}}>
            <div className='d-flex justify-content-between' style={{width: 'auto', height: 47 / proporcional, marginBottom: 32 / proporcional}}>
                <h2 style={{fontSize: 36 / proporcional, lineHeight: `${47 / proporcional}px`, marginBottom: 0, color: 'rgb(51, 51, 51)', fontWeight: 700, 
                    fontFamily: 'Lemonada, sans-serif', textAlign: 'left', cursor: 'default'}}>
                    Tienda
                </h2>
            </div>
