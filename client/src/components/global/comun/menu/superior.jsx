...
export default function MenuSuperior({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 5 / proporcional, paddingBottom: 5 / proporcional, paddingLeft: 10 / proporcional, 
            paddingRight: 10 / proporcional, background: 'rgb(160, 179, 27)'}}>
            <div style={{width: '100%', height: 'auto', paddingLeft: 150 / proporcional, paddingRight: 150 / proporcional, paddingTop: 10 / proporcional,
