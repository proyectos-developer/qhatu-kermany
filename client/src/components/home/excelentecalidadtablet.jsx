...
export default function ExcelenteCalidadTablet({proporcional}) {

    return (
        <div style={{width: '100%', height: 450 / proporcional, marginTop: 60 / proporcional}}>
            <div style={{width: '100%', height: 450 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional,
                ...
                <div className='' style={{width: '100%', height: 150 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
