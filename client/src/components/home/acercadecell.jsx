...
export default function AcercaDeTablet({proporcional}) {

    const [boton_mas, setBotonMas] = useState(false)

    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional, marginBottom: 20 / proporcional}}>
