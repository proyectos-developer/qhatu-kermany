...
export default function BannerPrincipal({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 900 / proporcional, marginBottom: 20 / proporcional}}>
            <div id='carouselbannerhome' className='carousel slide' style={{width: '100%', height: 900 / proporcional}}>
                ...
                <div className='carousel-inner' style={{width: '100%', height: 900 / proporcional}}>
                    <div className='carousel-item active' style={{width: '100%', height: 900 / proporcional}}>
                        <div className='position-relative' style={{width: '100%', height: 900 / proporcional, backgroundImage: `url(${banner_00})`, backgroundPosition: 'center', backgroundSize: 'cover',
                            backgroundRepeat: 'no-repeat'}}>
                            <div style={{width: '100%', height: 900 / proporcional, background: 'rgba(89, 89, 89, 0.6)'}}/>
                            <div className='position-absolute' style={{width: '40%', height: 'auto', left: 160 / proporcional, top: '30%'}}>
                    ...
                    <div className='carousel-item' style={{width: '100%', height: 900 / proporcional}}>
                        <div className='position-relative' style={{width: '100%', height: 900 / proporcional, backgroundImage: `url(${banner_01})`, backgroundPosition: 'center', backgroundSize: 'cover',
                            backgroundRepeat: 'no-repeat'}}>
                            <div style={{width: '100%', height: 900 / proporcional, background: 'rgba(89, 89, 89, 0.6)'}}/>
                            <div className='position-absolute' style={{width: '40%', height: 'auto', left: 160 / proporcional, top: '30%'}}>
