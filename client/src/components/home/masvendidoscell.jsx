...
export default function MasVendidosCell({proporcional}) {
            ...
            <div style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div className='rounded-pill' style={{width: 'auto', height: 45 / proporcional, background: filtros === 'todos' || menu === 'todos' ? 'rgb(255, 180, 34)' : 'rgb(160,  179, 27)',
                                paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, cursor: 'pointer'}}
                                onMouseOver={() => setFiltros('todos')} onMouseLeave={() => setFiltros('')} onClick={() => setMenu('todos')}>
                        ...
                        <div className='rounded-pill' style={{width: 'auto', height: 45 / proporcional, background: filtros === 'berries' || menu === 'berries' ? 'rgb(255, 180, 34)' : 'rgb(160,  179, 27)',
                                paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, cursor: 'pointer'}}
                                onMouseOver={() => setFiltros('berries')} onMouseLeave={() => setFiltros('')} onClick={() => setMenu('berries')}>
                            <p style={{fontSize: 16 / proporcional, fontWeigh: 500, color: 'white', fontFamily: 'Poppins, sans-serif', marginBottom: 0, lineHeight: `${45 / proporcional}px`,
                                textAlign: 'center', marginBottom: 0 / proporcional}}>
                                Berries
                            </p>
                        </div>
                        <div className='rounded-pill' style={{width: 'auto', height: 45 / proporcional, background: filtros === 'citricos' || menu === 'citricos' ? 'rgb(255, 180, 34)' : 'rgb(160,  179, 27)',
                                paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, cursor: 'pointer'}}
                                onMouseOver={() => setFiltros('citricos')} onMouseLeave={() => setFiltros('')} onClick={() => setMenu('citricos')}>
                            <p style={{fontSize: 16 / proporcional, fontWeigh: 500, color: 'white', fontFamily: 'Poppins, sans-serif', marginBottom: 0, lineHeight: `${45 / proporcional}px`,
                                textAlign: 'center', marginBottom: 0 / proporcional}}>
                                Cítricos
                            </p>
                        ...
                        <div className='rounded-pill' style={{width: 'auto', height: 45 / proporcional, background: filtros === 'tropical' || menu === 'tropial' ? 'rgb(255, 180, 34)' : 'rgb(160,  179, 27)',
                                paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, cursor: 'pointer'}}
                                onMouseOver={() => setFiltros('tropical')} onMouseLeave={() => setFiltros('')} onClick={() => setMenu('tropical')}>
                            <p style={{fontSize: 16 / proporcional, fontWeigh: 500, color: 'white', fontFamily: 'Poppins, sans-serif', marginBottom: 0, lineHeight: `${45 / proporcional}px`,
                                textAlign: 'center', marginBottom: 0 / proporcional}}>
                                Tropicales
                            </p>
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardProductoCell proporcional={proporcional} producto={productos[2]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardProductoCell proporcional={proporcional} producto={productos[3]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardProductoCell proporcional={proporcional} producto={productos[4]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardProductoCell proporcional={proporcional} producto={productos[5]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardProductoCell proporcional={proporcional} producto={productos[6]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 30 / proporcional}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardProductoCell proporcional={proporcional} producto={productos[7]}/>
                        </div>
                    </div>
                </div>
            </div>
