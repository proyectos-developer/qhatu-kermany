...
import CardProducto from '../tienda/card/producto.jsx'

export default function MasVendidos({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 80 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
            <div style={{width: '100%', height: 'auto', paddingLeft: 150 / proporcional, paddingRight: 150 / proporcional}}>
                <div style={{width: '100%', height: 'auto'}}>
                    ...
                    <div style={{width: '100%', height: 'auto', marginBottom: 45 / proporcional, paddingLeft: 400 / proporcional, paddingRight: 400 / proporcional,
