...
import CardCategoriaFrutaTablet from './card/categoriafrutatablet.jsx'

export default function CategoriasFrutasTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 80 / proporcional, paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional}}>
            <div style={{width: '100%', height: 'audo', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                        <div style={{width: '48%', height: 'auto', padding: 15 / proporcional}}>
                            <CardCategoriaFrutaTablet proporcional={proporcional} categoria={categorias[0]}/>
                        </div>
                        <div style={{width: '48%', height: 'auto', padding: 15 / proporcional}}>
                            <CardCategoriaFrutaTablet proporcional={proporcional} categoria={categorias[1]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '48%', height: 'auto', padding: 15 / proporcional}}>
                            <CardCategoriaFrutaTablet proporcional={proporcional} categoria={categorias[2]}/>
                        </div>
                        <div style={{width: '48%', height: 'auto', padding: 15 / proporcional}}>
                            <CardCategoriaFrutaTablet proporcional={proporcional} categoria={categorias[3]}/>
                        </div>
                    </div>
                </div>
            </div>
