...
export default function ExcelenteCalidad({proporcional}) {

    return (
        <div style={{width: '100%', height: 450 / proporcional, marginTop: 60 / proporcional}}>
            <div style={{width: '100%', height: 450 / proporcional, paddingLeft: 250 / proporcional, paddingRight: 250 / proporcional,
                ...
                <div className='' style={{width: '100%', height: 150 / proporcional, paddingLeft: 120 / proporcional, paddingRight: 120 / proporcional}}>
