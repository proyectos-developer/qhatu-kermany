...
export default function NestroBlogCell({proporcional}) {
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlogCell proporcional={proporcional} blog={blog[0]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlogCell proporcional={proporcional} blog={blog[1]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlogCell proporcional={proporcional} blog={blog[2]}/>
                        </div>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '90%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlogCell proporcional={proporcional} blog={blog[3]}/>
                        </div>
                    </div>
                </div>
            </div>
