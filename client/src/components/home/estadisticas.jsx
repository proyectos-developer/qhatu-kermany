...
export default function Estadisticas({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', marginTop: 80 / proporcional, marginBottom: 10 / proporcional}}>
            <div style={{width: '100%', height: 'auto', backgroundImage: `url(${estadisticas})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',
                paddingLeft: 160 / proporcional, paddingRight: 160 / proporcional, paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional}}>
