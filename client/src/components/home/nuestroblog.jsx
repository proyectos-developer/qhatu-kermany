...
export default function NestroBlog({proporcional}) {
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '24%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlog proporcional={proporcional} blog={blog[0]}/>
                        </div>
                        <div style={{width: '24%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlog proporcional={proporcional} blog={blog[1]}/>
                        </div>
                        <div style={{width: '24%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlog proporcional={proporcional} blog={blog[2]}/>
                        </div>
                        <div style={{width: '24%', height: 'auto', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                            <CardBlog proporcional={proporcional} blog={blog[3]}/>
                        </div>
                    </div>
                </div>
            </div>
